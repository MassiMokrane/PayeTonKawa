// describe('��� Auth Service - Tests simples', () => {
...
//   test('✅ bcrypt peut hasher des mots de passe', () => {
...
//   test('✅ Environnement de test configuré', () => {
//     // En CI, NODE_ENV sera 'test'
//     if (process.env.NODE_ENV === 'test') {
//       expect(process.env.DB_HOST).toBeDefined();
//       expect(process.env.JWT_SECRET).toBeDefined();
//     } else {
//       // En local, c'est OK si pas défini
